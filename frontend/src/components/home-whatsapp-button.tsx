...
export function HomeWhatsAppButton({ lift = false }: { lift?: boolean }) {
  ...
  return (
    <a
      ...
      className={`fixed right-4 z-[80] grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-white shadow-[0_10px_24px_rgba(37,211,102,0.45)] transition hover:bg-[#1ebe57] lg:bottom-8 lg:right-8 ${
        lift
