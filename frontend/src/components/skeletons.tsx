  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center gap-3 px-4 py-6 sm:px-8 lg:px-14">
        ...
        <Skeleton className="h-9 w-48 sm:h-11 sm:w-72" />
      </div>
    </section>
  );
}

export function CollectionRowSkeleton({ count = 3 }: { count?: number }) {
  return (
...
export function CollectionPageSkeleton() {
  return (
    <section className="flex min-h-0 flex-1 flex-col" aria-hidden>
      ...
      <div className="px-4 pt-6 lg:mx-auto lg:w-full lg:max-w-[1440px] lg:px-8">
...
export function AdminStatsSkeleton({ count = 4 }: { count?: number }) {
  return (
    <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4" aria-hidden>
      {Array.from({ length: count }, (_, index) => (
...
export function AdminFormSkeleton() {
  return (
    <div className="mt-8 space-y-4" aria-hidden>
      <Skeleton tone="admin" className="h-11 w-full" />
      <Skeleton tone="admin" className="h-11 w-full" />
      <Skeleton tone="admin" className="h-11 w-2/3" />
    </div>
  );
}
